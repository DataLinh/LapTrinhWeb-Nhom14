				...
				<div class="row">
					<div class="col-xl-5 col-lg-7 col-md-8">
						<div class="hero__text">
							...
							<p>Thương hiệu đắt tiền. Được làm một cách cẩn thận, chuyên
								nghiệp đề có được chất lượng ngoài mong đợi</p>
							<a href="#" class="primary-btn">Mua sắm ngay <span
		...
		<div class="row">
			<div class="col-lg-3">
				<div class="categories__text">
					<h2>
						Quần áo<br /> <span>Bộ sưu tập giày</span> <br /> Trang sức
					</h2>
				</div>
			</div>
			<div class="col-lg-4">
		...
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="instagram__text">
					<h2>Instagram</h2>
					<p>Chúng tôi luôn lắng nghe, tiếp nhận những đóng góp, ý kiến
						của khách hàng các bạn để đưa ra chất lượng dịch vụ tốt nhất.</p>
					<h3>#Male_Fashion</h3>
				</div>
			</div>
		</div>
